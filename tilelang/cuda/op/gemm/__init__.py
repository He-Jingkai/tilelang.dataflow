...
from .gemm_scalar import GEMM_INST_CUDA_SCALAR, GemmCudaScalar
...
def match_cuda_scalar(target) -> bool:
    return target_is_cuda(target)
...
register_gemm_impl("cuda.scalar", GEMM_INST_CUDA_SCALAR, match_cuda_scalar, GemmCudaScalar)
