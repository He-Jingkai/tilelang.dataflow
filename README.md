...
MoE results updated on 2026-09-10; MLA results
retained from 2026-08-18.
...
Measurements use NVIDIA H100 80GB HBM3 GPUs, sequentially, with one fresh Python process
per point, one measured round, 5 warmups, and 30 samples. Observed active clocks
were 1980 MHz SM and 2619 MHz HBM; PyTorch was 2.11.0+cu130 and NVCC was 13.0.88.
...
FP8, 32 experts, and `top_k=2`, with matching per-expert
token counts derived from `EXPERT_HEAT` in
[`benchmark.py`](./examples/dataflow/fusedmoe/benchmark.py):
...
- MegaMoE metric: p50 of 30 freshly measured Kineto/CUPTI kernel durations.
...
| --- | ---: | ---: | ---: | ---: |
| DeepSeek | 128 | 443.760 | 494.7935 | +11.500% |
| DeepSeek | 256 | 479.168 | 512.5215 | +6.961% |
| DeepSeek | 512 | 503.168 | 549.5450 | +9.217% |
| DeepSeek | 1024 | 550.752 | 574.1525 | +4.249% |
| Qwen | 128 | 74.960 | 86.5270 | +15.431% |
| Qwen | 256 | 79.504 | 87.0385 | +9.477% |
| Qwen | 512 | 77.312 | 94.3830 | +22.081% |
| Qwen | 1024 | 82.752 | 109.4865 | +32.307% |

tilelang.dataflow passed bitwise checks.
...
This project is still undergoing further refactoring:

- [ ] Integrate TMA multicast into the general scheduling path to accelerate
  scenarios such as shared-prefix loading in attention. This capability is
  currently available through `copy_cluster`.
- [ ] Complete comprehensive testing on NVIDIA Blackwell GPUs.
